...
# ============================================================================
"""CMD QUEST v1.6 — 10-round audit batch 5 fix (V46-V54).

Fix bug v1.5 audit:
- V46: max prereq depth 75 > 8 (quest_constants.recursion_guard.max_progression_depth).
       Root: template prereq=[qid-1] stack 30 templates + chain prereq stack.
       Fix: drop template seq prereq (use chain prereq only); MAX_CHAIN_LEN=8.
       Depth now <= 7.

V47/V48/V49/V50/V51/V52/V53/V54 verified PASS (no bug).

Previous fixes:
- v1.5 (V36-V44): legacy era alert, orphan chain_id clear, chain min 5.
- v1.4 (V26-V34): era pool filter, title unique, reward cap, era-level band,
  lore codex, Spearman fix, description variety.
- v1.3 (V11-V21): chain length cap 15, dialog preserve, level cap 120, etc.
