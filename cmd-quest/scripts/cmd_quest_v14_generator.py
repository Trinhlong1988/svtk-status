...
# ============================================================================
"""CMD QUEST v1.4 — 10-round deeper audit fixes on top of v1.3.

Fix bug v1.3 audit:
- V26: convert legacy era via chain_id (f1+g1 schema → canonical era).
       Filter giver pool by era when picking giver.
- V27: title uniqueness via qid-derived suffix (Hồi N / Phần N).
- V28: cap reward scaling (main exp +30/qid * cap 1500, raid gold cap 15000).
- V31: generated quest level scale by era position (g1 1-30, nguyen 80-120).
- V32: legacy lore convert sets unlocks_codex=True.
- V34: description vary per quest qua location + era + objective_type.

Previous version fixes (v1.2 / v1.3):
- V11/V13/V15/V16/V17/V19/V20/V21 (chain cap, dialog preserve, level cap,
  smart NPC, NPC#1 exclude, per-era suffix, last-era unlocks).
- R71/R72/R74/R82/R83/R50 Foundation v2.8.0 compliance.
"""
import os
import sys
import time
