...
# ============================================================================
"""CMD QUEST v1.7 — 10-round audit batch 6 fix (V56-V64).

Fix bug v1.6 audit:
- V59: preserve giver_npc_name + giver_scene_id từ NPC registry lookup,
       cho legacy + template + generated. Pre-existing TS test
       npc_ref_and_chain_playability.test.ts check 2 field này.

V56/V57/V58/V60/V61/V62/V63/V64 verified PASS (no bug).

Previous fixes v1.2-v1.6: 14+ bug fix qua 55 vòng audit.
"""
import os
import sys
import time
