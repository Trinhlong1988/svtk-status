-- CMD_PLACE v2.3.0 schema — auto từ ERAS/BIOMES/TARGET
CREATE TABLE IF NOT EXISTS place_items (
    ...
    CHECK (era IN ('ly','tran','le','tay_son','nguyen','f1','f2','f3','f4','f5')),
    CHECK (biome IN ('forest','mountain','river','plain','sea','swamp','craft_village','rice_field','fishing_village','salt_field','plantation','wharf','capital','capital_inner','town','village','citadel','frontier_pass','battlefield','cave','scenic','garden')),
